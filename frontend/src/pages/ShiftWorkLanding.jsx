          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            ...
            <div className="border-b border-gray-200 pb-4 sm:pb-8">
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                  <label htmlFor="currentWaketime" className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">
                    Wake Time
                  </label>
                  <HourMinuteSelect
        ...
        <div className="flex justify-center pt-6 sm:pt-8">
          ...
          >
            {loading ? (
              ...
              <>
                <span className="text-sm sm:text-base">Generate My Shift Work Plan</span>
